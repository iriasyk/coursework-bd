    ...
    if request.method == 'POST':
        if form.validate() == False:
            ...
            try:
                ...
                form.student_email.errors = ['Maybe this name already exists!']
                form.department_number.errors = ['Perhaps this name does not exist, from the parent tables where it should exist!']
                form.form_name.errors = ['Perhaps this name does not exist, from the parent tables where it should exist!']
                form.answers_on_questions.errors = ['Perhaps this name does not exist, from the parent tables where it should exist!']
                return render_template('student_form.html', form=form, form_name="New student", action="new_students")
